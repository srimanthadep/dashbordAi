...
export function DataVisualization({ data, columns }: DataVisualizationProps) {
  ...
  const handleExportChart = async (format: string) => {
    ...
    if (format === 'png' || format === 'pdf') {
      ...
      // Try to find an SVG element inside the chart
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-gradient-card border-border/50 shadow-card" role="region" aria-label="Data visualization panel">
        <div className="mb-6">
